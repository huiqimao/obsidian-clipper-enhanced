...
export type SettingsSection = 'general' | 'properties' | 'highlighter' | 'interpreter' | 'reader' | 'feishu' | 'templates';
	...
	if (sidebar) {
		sidebar.addEventListener('click', (event) => {
			...
			if (section === 'general'
				...
				|| section === 'reader'
				|| section === 'feishu') {
				showSettingsSection(section as 'general' | 'properties' | 'highlighter' | 'interpreter' | 'reader' | 'feishu');
			}
